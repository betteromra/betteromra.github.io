...
const allGames = {
  list: [
    {
      name: "PROJECT WINDLESS",
      logo: true,
      date: "January 2026 ~ May 2026",
      technologies: [5, 1, 8, 9],
      description: "An upcoming single-player, open world action RPG, set in the fantasy universe of the Korean novel series The Bird That Drinks Tears",
      role: "Tool Programmer",
      team: 86,
      time: "5 months",
      genre: ["Open World", "Action RPG", "Adventure"],
      style: ["Korean fantasy", "Realistic", "Dark"],
      link: [],
    },
    {
      name: "The Melty Way",
      logo: true,
      date: "December 2021 ~ May 2026",
      technologies: [6, 0, 7, 9, 11],
    ...
    },
    {
      ...
      technologies: [6, 0, 7],
      description: "In this whimsical multiplayer platformer, a tiny snail journeying through surreal dreamscapes. As a team of two, it is needed to collect scattered dreams and keep the dreamer peacefully asleep.",
      role: "Gameplay Programmer",
      team: 8,
      time: "3 months",
    ...
    },
    {
      ...
      team: 7,
      time: "2 weeks",
      genre: ["Automatisation", "Crafting", "Building"],
      style: ["2.5D", "Hand painted", "Cardboard"],
      link: ["https://betteromra.itch.io/pawtumn-harvest"],
    },
    {
      name: "Her Feather's Fire",
      logo: true,
      date: "January 2026",
      technologies: [11],
      description: "You are a crow flying through a village trying to understand what is happening in the human world.",
      role: "Artist",
      team: 6,
      time: "3 days",
      genre: ["Story", "Point and Click, Side Scroller"],
      style: ["Hand painted"],
      link: ["https://acaciesong.itch.io/her-feathers-fire"],
    },
    {
      name: "The Orc Cook",
      logo: true,
